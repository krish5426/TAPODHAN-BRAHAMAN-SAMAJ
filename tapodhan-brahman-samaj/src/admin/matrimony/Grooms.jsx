...
import { fetchAdminGrooms, importAdminProfiles, API_URL } from "../services/api";
...
function Grooms() {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const data = await fetchAdminGrooms();
                ...
                console.error("Failed to fetch grooms:", err);
            } finally {
                setLoading(false);
            }
        };
